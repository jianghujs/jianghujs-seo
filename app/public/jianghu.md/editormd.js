...
; (function (factory) {
    ...
    editormd.emoji = {
        path: "/static/jianghu.md/plugins/emoji-dialog/emoji/",
        ext: ".png"
    };
    ...
    editormd.markdownToHTML = function (id, options) { // Markdown 渲染为 HTML
        var defaults = { // 默认属性
            ...
            previewCodeHighlight: true,
            plugin_path: `/${window.appInfo.appId}/public/jianghu.md/lib/`
        };
    ...
    editormd.katexURL = {
        css: `/${window.appInfo.appId}/public/jianghu.md/lib/katex/katex.min`,
        js: `/${window.appInfo.appId}/public/jianghu.md/lib/katex/katex.min`,
    };
