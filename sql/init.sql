...
CREATE TABLE `_page` (
  ...
  `operationAt` varchar(255) DEFAULT NULL COMMENT '操作时间; E.g: 2021-05-28T10:24:54+08:00 ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 COMMENT = '页面表; 软删除未启用;';
...
) ENGINE = InnoDB AUTO_INCREMENT = 2960 COMMENT = '数据历史表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 97 COMMENT = '用户session表; deviceId 维度;软删除未启用;';
